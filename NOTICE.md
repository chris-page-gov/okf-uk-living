...
Repository-authored code, documentation and ontology terms are available under
the [MIT License](LICENSE). That grant applies only to material authored for
this repository; it does not relicense material owned by source providers.

## Open Government Licence material
...
personal data, logos, crests, the Royal Arms and identified third-party rights.

This repository currently links to and summarizes those pages. It does not
redistribute their page content or assets.

If HSE Crown material is ever reused rather than merely linked and summarized,
use the provider's preferred acknowledgement: “Contains public sector
information published by the Health and Safety Executive and licensed under
the Open Government Licence.” HSE logos and separately identified visual,
multimedia, third-party and excluded product material are not covered by that
statement.

## Reference standards

- **CPSV-AP 3.2.0:** the specification states that its material is licensed
  under [CC BY 4.0](https://creativecommons.org/licenses/by/4.0/) unless stated
  otherwise, with copyright attributed to the European Union. Any reuse must
  identify the creator, title and source, link the licence, retain supplied
  notices and indicate changes.
- **Open Referral UK:** the current website says most website content is under
  the [Open Government Licence](https://openreferraluk.org/info/terms). Its
  statement that GitHub code bases use “CC BY-SA” does not name a version, so
  this repository does not infer one for those repositories.
- **HSDS:** the current Human Services Data Specification documentation is
  licensed under
...
The complete dated decisions and evidence are in
[LICENSE_DECISIONS.md](LICENSE_DECISIONS.md) and the machine-readable
[rights register](source/rights-decisions.v1.yaml).
