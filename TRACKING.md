...
- Review state: the integrated local Explorer remediation rerun passed on
  ...
  full corpus is a frozen local population-complete candidate, not a release-grade
  or publication candidate. The separate initial sample is not a frozen
  publication candidate until `SCOPE-001` is approved.
