...
| PACK-004 | Populate home, place and transport | Active | 36 families across housing, rubbish/street and public/private transport |
...
- Acquisition: 89 exhaustive-inventory references, 53 implemented-slice
  references, 45 Pack 1 sources, 44 Pack 2 sources and 45 Pack 3 sources give
  276 source records and zero snapshots; all 29 source hosts
...
- Population implementation: owner-authorized on 2026-08-08 in eight packs;
  ...
  authority/source infrastructure and `PACK-001` through `PACK-003` complete;
  `PACK-004` is active.
