...
| RIGHTS-001 | Resolve repository and bounded source-family licensing | Complete | Merged in PR #6 with 16 slice hosts; later inventory and authority phases extend dated decisions to 28 hosts while retaining link-and-summary use and zero snapshots |
...
| PACK-003 | Populate work and money | Active | 36 families across finding work, employment and money/tax/benefits |
...
- Acquisition: 89 exhaustive-inventory references, 53 implemented-slice
  references, 45 Pack 1 sources and 44 Pack 2 sources give 231 source records
  and zero snapshots; all 28 source hosts
...
- Population implementation: owner-authorized on 2026-08-08 in eight packs;
  ...
  authority/source infrastructure, `PACK-001` and `PACK-002` complete;
  `PACK-003` is active.
