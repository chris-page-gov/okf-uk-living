...
| PAGES-001 | Deploy frozen candidate bytes to GitHub Pages | Active | Merge the manual-only Pages workflow, enable workflow-based Pages without changing repository visibility, and deploy the named candidate |
...
- Remote CI: disabled.
- GitHub Pages: publication authorized; exact-byte manual deployment pending.
