...
publication authorization. The already frozen and verified Pages preview is
unchanged; a future publication candidate must be rebuilt and reviewed through
the existing freeze and exact-byte gates.
