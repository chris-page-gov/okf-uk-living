...
`PACK-002` learning-and-transition and `PACK-003` work-and-money corpora are
...
1. `PACK-004` through `PACK-008` — populate the five remaining contracted domain packs, beginning with home, place and transport.
