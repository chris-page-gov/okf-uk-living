...
These three YAML fixtures define the minimum acceptance boundary for the first
implementation slices. They are synthetic, `editorial-example` contracts, not
official service data and not personalized decision rules:
...
source families are planning inputs only; acquisition remains `not_started`.
