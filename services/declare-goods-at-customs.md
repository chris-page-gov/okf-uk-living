---
type: "Service Family"
title: "Declare goods at customs"
description: "Check the route, goods, value and allowance rules and use the current declaration channel before or at the border when required."
...
This topic sits within **Prepare for international travel** in the **Holidays, volunteering and living overseas** life-course
...
Check the route, goods, value and allowance rules and use the current declaration channel before or at the border when required.
...
- [England: Bringing goods into the UK for personal use](https://www.gov.uk/bringing-goods-into-uk-personal-use)
- [Scotland: Bringing goods into the UK for personal use](https://www.gov.uk/bringing-goods-into-uk-personal-use)
- [Wales: Bringing goods into the UK for personal use](https://www.gov.uk/bringing-goods-into-uk-personal-use)
- [Northern Ireland: Bringing goods into the UK for personal use](https://www.gov.uk/bringing-goods-into-uk-personal-use)
...
The result can feed the next family in **Prepare for international travel**, another enclosing
