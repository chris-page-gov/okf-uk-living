---
type: "Service Family"
title: "Report a product safety issue"
description: "Stop unsafe use where necessary, preserve product and incident details and report to the seller and designated safety authority route."
status: "population-complete"
assertion_status: "normalized"
jurisdiction: "nation-specific"
observed_at: "2026-08-08"
sources:
  - id: "shopping-and-consumer-rights-source-register"
    title: "Shopping and consumer rights"
    resource: "../source/domain-registers/shopping-and-consumer-rights.v1.yaml"
    author: "organisation:okf-uk-living"
    observed_at: "2026-08-08"
---

# Report a product safety issue

## Place in the process

This topic sits within **Report harm and use consumer redress** in the **Shopping and consumer rights** life-course
...
Stop unsafe use where necessary, preserve product and incident details and report to the seller and designated safety authority route.
...
- [England: Product safety for consumers](https://www.gov.uk/guidance/consumer-products-reporting-product-safety-issues)
- [Scotland: Consumer rights in Scotland](https://www.mygov.scot/consumer-rights)
- [Wales: Product safety for consumers](https://www.gov.uk/guidance/consumer-products-reporting-product-safety-issues)
- [Northern Ireland: Consumer rights in Northern Ireland](https://www.gov.uk/consumer-protection-rights)
...
The result can feed the next family in **Report harm and use consumer redress**, another enclosing
