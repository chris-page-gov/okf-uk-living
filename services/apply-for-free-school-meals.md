...
description: "Find the current school-meal support route and submit an application where one is required."
...
Find the current school-meal support route and submit an application where one is required.
...
- [England: Apply for free school meals](https://www.gov.uk/apply-free-school-meals)
