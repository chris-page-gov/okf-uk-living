---
type: "Service Family"
title: "Register a design"
description: "Identify the visual features and ownership, preserve novelty where required and use the current application, examination and registration route."
...
Identify the visual features and ownership, preserve novelty where required and use the current application, examination and registration route.
...
- [England: Register a design](https://www.gov.uk/register-a-design)
- [Scotland: Register a design](https://www.gov.uk/register-a-design)
- [Wales: Register a design](https://www.gov.uk/register-a-design)
- [Northern Ireland: Register a design](https://www.gov.uk/register-a-design)
