---
type: "Service Family"
title: "Establish a social enterprise"
description: "Define the social purpose, choose a legal structure and use its company, charity, co-operative, tax and regulator routes as applicable."
...
This topic sits within **Form and register an organisation** in the **Starting and running an organisation** life-course
...
Define the social purpose, choose a legal structure and use its company, charity, co-operative, tax and regulator routes as applicable.
...
- [England: Setting up a social enterprise](https://www.gov.uk/set-up-a-social-enterprise)
- [Scotland: Setting up a social enterprise](https://www.gov.uk/set-up-a-social-enterprise)
- [Wales: Setting up a social enterprise](https://www.gov.uk/set-up-a-social-enterprise)
- [Northern Ireland: Setting up a social enterprise](https://www.gov.uk/set-up-a-social-enterprise)
...
The result can feed the next family in **Form and register an organisation**, another enclosing
