---
type: "Service Family"
title: "Register as a sole trader"
description: "Confirm the chosen structure, start the required records and use the current HMRC registration and reporting route."
...
Confirm the chosen structure, start the required records and use the current HMRC registration and reporting route.
...
- [England: Set up as a sole trader](https://www.gov.uk/set-up-sole-trader)
- [Scotland: Set up as a sole trader](https://www.gov.uk/set-up-sole-trader)
- [Wales: Set up as a sole trader](https://www.gov.uk/set-up-sole-trader)
- [Northern Ireland: Set up as a sole trader](https://www.gov.uk/set-up-sole-trader)
