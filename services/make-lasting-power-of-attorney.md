---
type: "Service Family"
title: "Make a lasting power of attorney"
description: "Choose the applicable legal instrument and attorneys, complete and register it while the donor can make the decision and obtain advice for conflicts or complexity."
status: "population-complete"
assertion_status: "normalized"
jurisdiction: "nation-specific"
observed_at: "2026-08-08"
sources:
  - id: "later-life-source-register"
    title: "Later life"
    resource: "../source/domain-registers/later-life.v1.yaml"
...
This topic sits within **Arrange later-life care and future decisions** in the **Later life** life-course
...
Choose the applicable legal instrument and attorneys, complete and register it while the donor can make the decision and obtain advice for conflicts or complexity.
...
- [Scotland: Benefits in Scotland](https://www.mygov.scot/browse/benefits)
- [Wales: Make, register or end a lasting power of attorney](https://www.gov.uk/power-of-attorney)
- [Northern Ireland: Pensions and retirement planning](https://www.nidirect.gov.uk/information-and-services/pensions-and-retirement-planning)
...
The result can feed the next family in **Arrange later-life care and future decisions**, another enclosing
