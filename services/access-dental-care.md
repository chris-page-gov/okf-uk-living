---
type: "Service Family"
title: "Access dental care"
description: "Find a dental provider using the current NHS route, confirm the appointment basis and use the urgent or commissioning handoff when routine access is unavailable."
...
Find a dental provider using the current NHS route, confirm the appointment basis and use the urgent or commissioning handoff when routine access is unavailable.
...
- [England: How to find an NHS dentist](https://www.nhs.uk/nhs-services/dentists/how-to-find-an-nhs-dentist/)
