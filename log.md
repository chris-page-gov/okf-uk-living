...
- Completed the shared authority and source infrastructure with 382 principal
  areas, 19 strategic authorities, 397 GSS geographies, 438 organizations and
  ten regulator/redress sector maps.
- Recorded seven active metadata-only source receipts and three additional
  dated host-rights decisions without retaining any response body or snapshot.
- Expanded the local projection to 1,434 concepts and fixed record/search
  sharding at the 1,000-record threshold after a real Explorer hydration check.
- Browser-verified Financial Conduct Authority search/detail, publisher-paired
  `Ynys Môn` discovery, and shared HMCTS relationship navigation.
- Kept remote CI and GitHub Pages unchanged; publication still requires an
...
- Scaffolded curriculum, ontology, life-course, journey, service,
  jurisdiction, organisation and evidence sections.
- Added deterministic local build and validation commands.
- Registered 13 bounded official links for the missed-rubbish slice without
  acquiring snapshots.
- Added four local missed-collection routes, their responsible authorities,
